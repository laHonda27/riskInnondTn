...
function DropdownFilter({
  ...
  return (
    <div className="relative inline-flex">
      <button
        ref={trigger}
        className="btn-xs bg-white dark:bg-slate-800 border-slate-200 hover:border-slate-300 dark:border-slate-700 dark:hover:border-slate-600 text-slate-500 hover:text-slate-600 dark:text-slate-400 dark:hover:text-slate-300"
        aria-haspopup="true"
          ...
          <ul className="mb-4">
            <li className="py-1 px-3">
              <label className="flex items-center">
                ...
                <span className="text-sm font-medium ml-2">Décès</span>
              </label>
            </li>
            <li className="py-1 px-3">
              <label className="flex items-center">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm font-medium ml-2">Niveau d'eau</span>
              </label>
            </li>
            <li className="py-1 px-3">
              <label className="flex items-center">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm font-medium ml-2">Zone à risques</span>
              </label>
            </li>
          </ul>
