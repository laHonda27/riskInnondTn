...
function DropdownNotifications({
  ...
  <li className="border-b border-slate-200 dark:border-slate-700 last:border-0">
    <Link
      ...
      onClick={() => setDropdownOpen(!dropdownOpen)}
    >
      <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800 dark:text-slate-100">Alerte Inondation à Tunis</span> Des pluies torrentielles sont prévues dans la région de Tunis. Restez en sécurité et suivez les mises à jour locales.</span>
      <span className="block text-xs font-medium text-slate-400 dark:text-slate-500">3 septembre 2023</span>
    </Link>
  </li>
  <li className="border-b border-slate-200 dark:border-slate-700 last:border-0">
    <Link
      ...
      onClick={() => setDropdownOpen(!dropdownOpen)}
    >
      <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800 dark:text-slate-100">Évacuation Urgente à Ariana</span> En raison des inondations soudaines, une évacuation d'urgence est en cours à Ariana. Suivez les instructions des autorités locales.</span>
      <span className="block text-xs font-medium text-slate-400 dark:text-slate-500">2 septembre 2023</span>
    </Link>
  </li>
  <li className="border-b border-slate-200 dark:border-slate-700 last:border-0">
    <Link
      ...
      onClick={() => setDropdownOpen(!dropdownOpen)}
    >
      <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800 dark:text-slate-100">Aidez-nous à Secourir les Sinistrés</span> Nous avons besoin de bénévoles pour aider les personnes touchées par les inondations. Rejoignez-nous pour apporter votre aide.</span>
      <span className="block text-xs font-medium text-slate-400 dark:text-slate-500">1 septembre 2023</span>
    </Link>
  </li>
</ul>
        </div>
