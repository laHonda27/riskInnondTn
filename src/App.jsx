...
import DocPresse from './pages/DocPresse';
import DocScientifique from './pages/DocScientifique';
import ForumCommunautaire from './pages/ForumCommunautaire';
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/cartographie/:regionName" element={<CartographieDetail />} />
        <Route path="/Metriques" element={<Metriques />} />
        <Route path="/documentation/scientifique" element={<DocScientifique />} />
        <Route path="/documentation/presse" element={<DocPresse />} />
        <Route path="/forumCommunautaire" element={<ForumCommunautaire />} />
